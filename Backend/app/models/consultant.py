...
class ConsultantInviteCode(Base):
    ...
    consultant_id: Mapped[str] = mapped_column(Text, ForeignKey("users.id"), nullable=False)
    ...
    default_access_mode: Mapped[str | None] = mapped_column(Text)
...
class ConsultantAccessGrant(Base):
    ...
    invite_code_id: Mapped[str | None] = mapped_column(
        Text, ForeignKey("consultant_invite_codes.id")
    )
    ...
    requested_at: Mapped[str] = mapped_column(Text, nullable=False, default=utcnow_iso)
...
class FilingChangeSet(Base):
    ...
    grant_id: Mapped[str] = mapped_column(
        Text, ForeignKey("consultant_access_grants.id"), nullable=False
    )
    consultant_id: Mapped[str] = mapped_column(Text, ForeignKey("users.id"), nullable=False)
